...
import { IProductCreateInput, IProduct } from "../../types/product";
import { deleteResponse } from "../../types/deleteResponse";

class Products extends Collection {
  constructor(model: Model<IProductCreateInput>) {
    super(model);
  }

  createProduct(data: IProductCreateInput): Promise<IProduct> {
    return this.createDocument<IProduct>(data);
  }

  createManyProducts(data: IProductCreateInput[]): Promise<IProduct[]> {
